...
var sockerport = setup.SERVER.SOCKERPORT;
...
var sockerserver = net.createServer(function (sock) {
...
function cb_deployed(e) {
	if (e != null) {
		...
		sockerserver.listen(sockerport, host);
		console.log('Server listening on ' + host + ':' + sockerport);
